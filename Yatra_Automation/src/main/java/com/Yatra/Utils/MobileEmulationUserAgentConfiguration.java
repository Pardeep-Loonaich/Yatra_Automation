...
public class MobileEmulationUserAgentConfiguration {
	...
	public static final String GALAXY_S5Galaxy_S5="Galaxy S5";
	...
	private final HashMap<String, String> apple_ipad4_ios9 = new HashMap<String, String>() {
		{
			put("userAgent", "Mozilla/5.0 (iPad; CPU OS 9_3_3 like Mac OS X) AppleWebKit/601.1.46 (KHTML, like Gecko) Version/9.0 Mobile/13G34 Safari/601.1");
			put("width", "768");
			put("height", "1024");
			put("pixelRatio", "2");
		}
