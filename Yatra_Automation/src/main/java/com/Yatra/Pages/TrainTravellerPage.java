...
public class TrainTravellerPage extends LoadableComponent<TrainTravellerPage> {
	...
	@FindBy(css = "#gender1")
	private WebElement dd_Pax1Gender;

	@FindBy(css = "#berth1")
	private WebElement dd_Pax1Berth;

	@FindBy(css = "#gender2")
	private WebElement dd_Pax2Gender;

	@FindBy(css = "#berth2")
	private WebElement dd_Pax2Berth;
	...
	public void loginAsSignedUser(String userName, String password) throws Exception {
		...
		BrowserActions.clickOnElement(btnProccedAsSignedUser, driver,
				"Clicked on 'Proceed as signed In users' button.");
	}
	...
	public void fillTravellerDetails() throws Exception {
		List<WebElement> lstPax = driver
				.findElements(By.cssSelector("ul[id='paxStripContainer']>li[class='horzSeprB pb5']"));
		for (int i = 0; i < lstPax.size(); i++) {
			BrowserActions.clickOnElement(
					lstPax.get(i).findElement(By.cssSelector("div[class='flL ml10 select-input relative']>label")),
					driver, "Clicked on title dropdown.");
			List<WebElement> lstTitle = lstPax.get(i)
					.findElements(By.cssSelector("div[class='flL ml10 select-input relative']>label>select>option"));
			if (lstTitle.size() != 0) {
				selectPaxOnegender();
				selectPaxSecondgender();
			}
			...
			BrowserActions.typeOnTextField(lstPax.get(i).findElement(By.cssSelector("input")), randomName, driver,
					"First Name");
			Log.event("Successfully entered Passenger name:" + randomName);

			BrowserActions.typeOnTextField(lstPax.get(i).findElement(By.cssSelector("div[class*='ageSel ']>input")),
					Age, driver, "Age");
			Log.event("Successfully entered Passenger name:" + rand1);
			BrowserActions.clickOnElement(lstPax.get(i).findElement(By.cssSelector("div[class*='berthPref']>label")),
					driver, "Clicked on Berth dropdown.");
			List<WebElement> lstBerth = lstPax.get(i)
					.findElements(By.cssSelector("div[class*='berthPref']>label>select>option"));
			if (lstBerth.size() != 0) {
				selectPaxFirstBerth();
				selectPaxSecondBerth();
				Utils.waitForPageLoad(driver);
			}
	...
	/**
	 * clicked on Continue In paxPage in case we fill invalid details and we are
	 * not navigated to review page.
	 * 
	 * @throws Exception
	 */
	...
	/**
	 * getting error message from the Popup appears for the inavlid IRCTC id and
	 * then close it.
	 * 
	 * @return
	 * @throws Exception
	...
	public String getTextFromInvalidIrctcIdPopUp() throws Exception {
		String errorMsg = BrowserActions.getText(driver, msgInvalidIrctcId,
				"Getting Text from the Invalid IRCTC Id Popup.");
	...
	/**
	 * getting text from the Popup Message that appears after the successfully
	 * updating mobile no.
	 * 
	 * @return
	 * @throws Exception
	...
	public String getSuccessMsgFromUpdateMobileNoPopUp() throws Exception {
		String successMsg = BrowserActions.getText(driver, msgMobileNoUpdate,
				"Getting Success Message after Updating MobileNo.");
		BrowserActions.moveToElementJS(driver, closeMobileNoUpdateMsgPopUp);
		BrowserActions.clickOnElement(closeMobileNoUpdateMsgPopUp, driver,
				"Close the Success Message after Updating Mobile no Popup.");
		return successMsg;
	}
	...
	public void enterMobileNmberToRestIrctcPswd(String number) throws Exception {
		BrowserActions.typeOnTextField(txtMobileIrctcResetPwrd, number, driver,
				"Entered the mobile number to reset Password.");
	}
	...
	public String getErrorMsgForInvalidMbleNmbr() throws Exception {
		...
		return BrowserActions.getText(driver, txtErrorMobileIrctcResetPwrd,
				"To get the text from the error msg on invalid mobile number.");
	...
	/**
	 * to get text from the invalid toader messages that appear after invalid
	 * data enteries
	 * 
	 * @return
	 * @throws Exception
	...
	public void verifyPaxDetails() throws Exception {
		...
		BrowserActions.typeOnTextField(lstPax.get(0).findElement(By.cssSelector("input")), randomName, driver,
				"First Name");
		Log.event("Successfully entered Passenger name:" + randomName);
	...
	public void verifyInfantDetails() throws Exception {
		...
		BrowserActions.typeOnTextField(driver.findElement(By.cssSelector("#childName1")), randomInfntName, driver,
				"First Infant Name");
	 ...
	 *       Exception
	 */
	public void selectPaxOnegender() throws Exception {
		BrowserActions.selectByValue(driver, dd_Pax1Gender, "MALE");
	}
	 ...
	 *       Exception
	 */
	public void selectPaxSecondgender() throws Exception {
		BrowserActions.selectByValue(driver, dd_Pax2Gender, "FEMALE");
	}
	 ...
	 *       Exception
	 */
	public void selectPaxFirstBerth() throws Exception {
		BrowserActions.selectByValue(driver, dd_Pax1Berth, "Lower");
	}
	 ...
	 *       Exception
	 */
	public void selectPaxSecondBerth() throws Exception {
		BrowserActions.selectByValue(driver, dd_Pax2Berth, "Lower");
	}
}// TrainTravellerPage
