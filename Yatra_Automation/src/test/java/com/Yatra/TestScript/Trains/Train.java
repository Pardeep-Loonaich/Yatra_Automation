...
public class Train {
	...
	@Test(groups = {
			"desktop" }, description = "Search Train ", dataProviderClass = DataProviderUtils.class, dataProvider = "multipleExecutionData")
	public void TC_Yatra_Train_001(HashMap<String, String> testData) throws Exception {
		...
		try {
			...
			Log.message("<br>");
			Log.assertThat(
					trainSearchResult.elementLayer.verifyPageElements(Arrays.asList("btnFindTrain"), trainSearchResult),
					"<b>Actual Result:</b> User successfully navigated to trains Search Result Page.",
					"<b>Actual Result:</b> User is not successfully navigated to trains Search Result Page.", driver);
	...
	public void TC_Yatra_Train_002(HashMap<String, String> testData) throws Exception {
		...
		try {
			...
			Log.message(
					"<b>Expected Result:</b> Verify proper message should be show after entering incorrect city name.");
			Log.message("<br>");
	...
	@Test(groups = {
			"desktop" }, description = "Search Train with code", dataProviderClass = DataProviderUtils.class, dataProvider = "multipleExecutionData")
	...
	@Test(groups = {
			"desktop" }, description = "Train Search Results should be sorted by depart in asc order", dataProviderClass = DataProviderUtils.class, dataProvider = "multipleExecutionData")
	...
	@Test(groups = {
			"desktop" }, description = "Should show pop-up with other options of flight and bus.", dataProviderClass = DataProviderUtils.class, dataProvider = "multipleExecutionData")
	public void TC_Yatra_Train_013(HashMap<String, String> testData) throws Exception {
		...
		try {
			...
			Log.message("<br>");
			Log.message(
					"<b>Expected Result:</b> Verify that Other Travelling options of flight and bus Popup should display  in case available..");
			Log.message("<br>");
			Log.assertThat(
					trainSearchResult.elementLayer.verifyPageElements(Arrays.asList("popupOtherRoute"),
							trainSearchResult),
					"<b>Actual Result:</b> Other Travelling Options Popup displayed for the selected train are as:"
							+ trainSearchResult.getTxtFromOtherTravelOption(),
					"<b>Actual Result:</b> Other Travelling Options Popup not displayed for the selected train.",
					driver);
			...
			Log.assertThat(
					trainSearchResult.elementLayer.verifyPageElements(Arrays.asList("popupOtherRouteInSideNav"),
							trainSearchResult),
	...
	@Test(groups = {
			"desktop" }, description = "Available class should be shown for selecting the train.", dataProviderClass = DataProviderUtils.class, dataProvider = "multipleExecutionData")
	public void TC_Yatra_Train_014(HashMap<String, String> testData) throws Exception {
		...
		try {
			...
			Log.message("<br>");
			Log.message(
					"<b>Expected Result:</b> Verify that after selecting train,it should show availability of seats..");
			Log.message("<br>");
			Log.assertThat(
					trainSearchResult.elementLayer.verifyPageElements(Arrays.asList("btnFindTrain"), trainSearchResult),
					"<b>Actual Result:</b> Successfully navigated to 'Train Search' page and the available seats for the selected train are:"
							+ trainSearchResult.checkAvailableClassBySelectingTrainByRow(1),
					"<b>Actual Result:</b> Unable to navigate to 'Train Search' page and the availabe seats are not visible.",
					driver);
	...
	@Test(groups = {
			"desktop" }, description = "Verify Should reset all filters.", dataProviderClass = DataProviderUtils.class, dataProvider = "multipleExecutionData")
	public void TC_Yatra_Train_019(HashMap<String, String> testData) throws Exception {
		...
		try {
			...
			Log.assertThat(result != result2, "<b>Actual Result:</b> Successfully reseted all filters.",
	...
	@Test(groups = {
			"desktop" }, description = "Check if its showing current status of available seats and it should be according to selected quota.", dataProviderClass = DataProviderUtils.class, dataProvider = "multipleExecutionData")
	public void TC_Yatra_Train_021(HashMap<String, String> testData) throws Exception {
		...
		try {
			...
			Log.message("<br>");
			Log.message(
					"<b>Expected Result:</b> Verify current status of available seats should be according to selected quota.");
			Log.assertThat(trainSearchResult.verifyQuotaByselectingTrainByIndex(1, quota),
					"<b>Actual Result:</b> Current Status of available seat is according to selected quota."
							+ trainSearchResult.checkDetailsBySelectingTrainNClassByRow(1, quota),
					"<b>Actual Result:</b> Unable to get current Status of available seat according to selected quota.",
					driver);
	...
	@Test(groups = {
			"desktop" }, description = "Verify Boarding points details should be correct.", dataProviderClass = DataProviderUtils.class, dataProvider = "multipleExecutionData")
	...
	@Test(groups = {
			"desktop" }, description = "Verify for FB login also(Verifying FB Link only).", dataProviderClass = DataProviderUtils.class, dataProvider = "multipleExecutionData")
	public void TC_Yatra_Train_025(HashMap<String, String> testData) throws Exception {
		...
		try {
			...
			Log.assertThat(
					trainTravellerPage.elementLayer.verifyPageElements(Arrays.asList("lnkFB"), trainTravellerPage),
					"<b>Actual Result:</b> When Login as Guest User the 'Login as Facebook User' link is displayed.",
					"<b>Actual Result:</b> When Login as Guest User the 'Login as Facebook User' link is not displayed.",
					driver);
	...
	@Test(groups = {
			"desktop" }, description = "Verify for validations on IRCTC id.", dataProviderClass = DataProviderUtils.class, dataProvider = "multipleExecutionData")
	public void TC_Yatra_Train_026(HashMap<String, String> testData) throws Exception {
		...
		try {
			...
			Log.assertThat(
					trainTravellerPage.elementLayer.verifyPageElements(Arrays.asList("popupInvalidIrctcId"),
							trainTravellerPage),
					"<b>Actual Result:</b> The Popup is appear when we entered the invalid IRCTC Id and click on 'Submit' and the error message is :."
							+ trainTravellerPage.getTextFromInvalidIrctcIdPopUp(),
					"<b>Actual Result:</b> The Popup is not appear when we entered the invalid IRCTC Id and click on 'Submit'.",
					driver);
	...
	@Test(groups = {
			"desktop" }, description = "Should be able to change boarding point.", dataProviderClass = DataProviderUtils.class, dataProvider = "multipleExecutionData")
	public void TC_Yatra_Train_027(HashMap<String, String> testData) throws Exception {
		...
		try {
			...
			Log.assertThat(
					trainTravellerPage.elementLayer.verifyPageElements(Arrays.asList("drpBoardingPnt"),
							trainTravellerPage),
	...
	@Test(groups = {
			"desktop" }, description = "Verify if IRCTC id is linked with yatra ID then it should not ask to enter IRCTC Id on login page.", dataProviderClass = DataProviderUtils.class, dataProvider = "multipleExecutionData")
	public void TC_Yatra_Train_028(HashMap<String, String> testData) throws Exception {
		...
		try {
			...
			Log.message("<br>");
			Log.message(
					"<b>Expected Result:</b> Verify if IRCTC id is linked with yatra ID then it should not ask to enter IRCTC Id on login page.");
			Log.assertThat(
					trainTravellerPage.elementLayer.verifyPageElements(Arrays.asList("btnResetIrctcPsswrd"),
							trainTravellerPage),
	...
	@Test(groups = {
			"desktop" }, description = "Verify if  If IRCTC Id is not linked with Yatra Id it will ask user to enter IRCTC Id and it should link that id with yatra one on confirmed booking.", dataProviderClass = DataProviderUtils.class, dataProvider = "multipleExecutionData")
	...
	@Test(groups = {
			"desktop" }, description = "Check for name, title & Age validations.", dataProviderClass = DataProviderUtils.class, dataProvider = "multipleExecutionData")
	public void TC_Yatra_Train_030(HashMap<String, String> testData) throws Exception {
		...
		try {
			...
			Log.assertThat(
					trainTravellerPage.elementLayer.verifyPageElements(Arrays.asList("toaderErrorMsg"),
							trainTravellerPage),
					"<b>Actual Result:</b> Error message displayed after filling wrong details. \n MSG:"
							+ trainTravellerPage.getErrorTxtFromTheToader(),
	...
	public void TC_Yatra_Train_031(HashMap<String, String> testData) throws Exception {
		...
		try {
			...
			Log.assertThat(
					trainTravellerPage.elementLayer.verifyPageElements(Arrays.asList("popUpMobileNoUpdate"),
							trainTravellerPage),
					"<b>Actual Result:</b> The Popup is appear when we edit Mobile Number and save it the success message is :."
							+ trainTravellerPage.getSuccessMsgFromUpdateMobileNoPopUp(),
	...
	@Test(groups = {
			"desktop" }, description = "Check for infant validations.", dataProviderClass = DataProviderUtils.class, dataProvider = "multipleExecutionData")
	...
	@Test(groups = {
			"desktop" }, description = "Check for reset password button.", dataProviderClass = DataProviderUtils.class, dataProvider = "multipleExecutionData")
	public void TC_Yatra_Train_034(HashMap<String, String> testData) throws Exception {
		...
		try {
			...
			Log.assertThat(
					trainTravellerPage.elementLayer.verifyPageElements(Arrays.asList("btnResetIrctcPswrd"),
							trainTravellerPage),
					"<b>Actual Result:</b> After clicking on 'Reset' button,Reset password module display.",
					"<b>Actual Result:</b> After clicking on 'Reset' button,Reset password module not display.",
					driver);
	...
	@Test(groups = {
			"desktop" }, description = "User should be able to select either email or SMS option.", dataProviderClass = DataProviderUtils.class, dataProvider = "multipleExecutionData")
	public void TC_Yatra_Train_035(HashMap<String, String> testData) throws Exception {
		...
		try {
			...
			Log.assertThat(
					trainTravellerPage.elementLayer.verifyPageElements(Arrays.asList("lblMobileResetPwd"),
							trainTravellerPage),
			...
			Log.message("<br>");
			Log.assertThat(
					trainTravellerPage.elementLayer.verifyPageElements(Arrays.asList("lblEmailResetPwd"),
							trainTravellerPage),
	...
	@Test(groups = {
			"desktop" }, description = "Should show steps and links to create new IRCTC profile.", dataProviderClass = DataProviderUtils.class, dataProvider = "multipleExecutionData")
	public void TC_Yatra_Train_037(HashMap<String, String> testData) throws Exception {
		...
		try {
			...
			Log.message("<br>");
			Log.message(
					"<b>Expected Result:</b> Verify should display steps and links to create new IRCTC profile,after clicking on Create New Link.");
			Log.assertThat(
					trainTravellerPage.elementLayer.verifyPageElements(Arrays.asList("lnkAsIndianRes",
							"lnkAsNonIndianResStep1", "lnkAsNonIndianResStep2", "lnkAsNonIndianResStep3"),
							trainTravellerPage),
	...
	@Test(groups = {
			"desktop" }, description = "Should show message 'Wrong userLoginId or mobile.", dataProviderClass = DataProviderUtils.class, dataProvider = "multipleExecutionData")
	...
	@Test(groups = {
			"desktop" }, description = "Check for modify itinerary.", dataProviderClass = DataProviderUtils.class, dataProvider = "multipleExecutionData")
	public void TC_Yatra_Train_043(HashMap<String, String> testData) throws Exception {
		...
		try {
			...
			Log.message("<br>");
			Log.message(
					"<b>Expected Result:</b> Verify after clicking on Modify Iternary button in Review Page,should redirect to TrainSearch page.");
			Log.assertThat(
					trainSearchResult.elementLayer.verifyPageElements(Arrays.asList("btnFindTrain"), trainSearchResult),
	...
	@Test(groups = {
			"desktop" }, description = "Verify Session strip should come on review page.", dataProviderClass = DataProviderUtils.class, dataProvider = "multipleExecutionData")
	public void TC_Yatra_Train_044(HashMap<String, String> testData) throws Exception {
		...
		try {
			...
			Log.assertThat(trainReviewPage.elementLayer.verifyPageElements(Arrays.asList("timeStrip"), trainReviewPage),
					"<b>Actual Result:</b> Strip showing time session is displayed and the time displayed is '" + time
							+ "' minutes.",
	...
	@Test(groups = {
			"desktop" }, description = "Check for eWallet div.", dataProviderClass = DataProviderUtils.class, dataProvider = "multipleExecutionData")
	...
	@Test(groups = {
			"desktop" }, description = "Should redirect with correct amount on PG.", dataProviderClass = DataProviderUtils.class, dataProvider = "multipleExecutionData")
	public void TC_Yatra_Train_048(HashMap<String, String> testData) throws Exception {
		...
		try {
			...
			Log.message(
					"<b>Expected Result:</b> Verify for eCash+ Cash Payment should redirect with correct amount on PG.");
	...
	@Test(groups = {
			"desktop" }, description = "Should redirect back to pax page,On session expires.", dataProviderClass = DataProviderUtils.class, dataProvider = "multipleExecutionData")
	...
	@Test(groups = {
			"desktop" }, description = "Confirmation page will come only after login on IRCTC successfully.", dataProviderClass = DataProviderUtils.class, dataProvider = "multipleExecutionData")
	public void TC_Yatra_Train_052(HashMap<String, String> testData) throws Exception {
		...
		try {
			...
			Log.message("<br>");
			Log.message(
					"<b>Expected Result:</b> Verify confirmation page will come only after login on IRCTC successfully.");
	...
	@Test(groups = {
			"desktop" }, description = "Should show selected train details,after clicking on booking summary drop down.", dataProviderClass = DataProviderUtils.class, dataProvider = "multipleExecutionData")
	public void TC_Yatra_Train_053(HashMap<String, String> testData) throws Exception {
		...
		try {
			...
			Log.message("<br>");
			Log.message(
					"<b>Expected Result:</b> Verify selected train details should display,after clicking on booking summary drop down.");
	...
	@Test(groups = {
			"desktop" }, description = "Should redirect to Bus SRP with same sectors after clicking on FindBus.", dataProviderClass = DataProviderUtils.class, dataProvider = "multipleExecutionData")
	public void TC_Yatra_Train_015(HashMap<String, String> testData) throws Exception {
		...
		try {
			...
			Log.message("<br>");
			Log.message(
					"<b>Expected Result:</b> Verify after clicking on FindBus button page should redirect to Bus SRP with same sectors .");
			Log.message("<br>");
			Log.assertThat(
					trainSearchResult.elementLayer.verifyPageElements(Arrays.asList("btnFindBuses"), trainSearchResult),
					"<b>Actual Result:</b> Successfully navigated to 'Bus Search' page after clicking on FindBus button.",
					"<b>Actual Result:</b> Unable to navigate to 'Bus Search' page after clicking on FindBus button.",
					driver);
	...
	@Test(groups = {
			"desktop" }, description = "Verify pop-up with option to change boarding points.", dataProviderClass = DataProviderUtils.class, dataProvider = "multipleExecutionData")
	public void TC_Yatra_Train_016(HashMap<String, String> testData) throws Exception {
		...
		try {
			...
			Log.assertThat(
					trainSearchResult.elementLayer.verifyPageElements(Arrays.asList("modalArriveInfo"),
							trainSearchResult),
	...
	@Test(groups = {
			"desktop" }, description = "Verify pop-up should show correct boarding point options.", dataProviderClass = DataProviderUtils.class, dataProvider = "multipleExecutionData")
	...
	@Test(groups = {
			"desktop" }, description = "Train Search Results should be sorted by arrival time in asc order", dataProviderClass = DataProviderUtils.class, dataProvider = "multipleExecutionData")
	...
	@Test(groups = {
			"desktop" }, description = "On selecting train,it should show availability of seats.", dataProviderClass = DataProviderUtils.class, dataProvider = "multipleExecutionData")
	public void TC_Yatra_Train_008(HashMap<String, String> testData) throws Exception {
		...
		try {
			...
			Log.assertThat(
					trainSearchResult.elementLayer.verifyPageElements(Arrays.asList("btnFindTrain"), trainSearchResult),
					"<b>Actual Result:</b> Successfully navigated to 'Train Search' page and the available seats for the selected train are:"
							+ trainSearchResult.checkDetailsBySelectingTrainNClassByRow(2, availSeat),
					"<b>Actual Result:</b> Unable to navigate to 'Train Search' page and the availabe seats are not visible.",
					driver);
	...
	@Test(groups = {
			"desktop" }, description = "Check for Quota drop down of seats.", dataProviderClass = DataProviderUtils.class, dataProvider = "multipleExecutionData")
	public void TC_Yatra_Train_009(HashMap<String, String> testData) throws Exception {
		...
		try {
			...
			Log.message("<br>");
			Log.message(
					"<b>Expected Result:</b> Verify that quota dropdown of train seats,it should show available quota..");
			Log.message("<br>");
			Log.assertThat(
					trainSearchResult.elementLayer.verifyPageElements(Arrays.asList("btnFindTrain"), trainSearchResult),
					"<b>Actual Result:</b> Successfully navigated to 'Train Search' page and the available seats quota for the selected train are:"
							+ trainSearchResult.selectQuota(),
					"<b>Actual Result:</b> Unable to navigate to 'Train Search' page and the available seats quota for the selected train are not visible.",
					driver);
	...
	@Test(groups = {
			"desktop" }, description = "Incase no seat is available, it should show an option to select bus.", dataProviderClass = DataProviderUtils.class, dataProvider = "multipleExecutionData")
	public void TC_Yatra_Train_010(HashMap<String, String> testData) throws Exception {
		...
		try {
			...
			Log.message("<br>");
			Log.message(
					"<b>Expected Result:</b> Verify that select bus option should display in case of no seat available..");
			Log.message("<br>");
			Log.assertThat(
					trainSearchResult.elementLayer.verifyPageElements(Arrays.asList("btnFindBus"), trainSearchResult),
	...
	@Test(groups = {
			"desktop" }, description = "Verify after selecting seat it should open pop-up for boarding point selection.", dataProviderClass = DataProviderUtils.class, dataProvider = "multipleExecutionData")
	public void TC_Yatra_Train_011(HashMap<String, String> testData) throws Exception {
		...
		try {
			...
			Log.message("<br>");
			Log.message(
					"<b>Expected Result:</b> Verify after selecting seat it should open pop-up for boarding point selection.");
			Log.message("<br>");
			Log.assertThat(
					trainSearchResult.elementLayer.verifyPageElements(Arrays.asList("modalArriveInfo"),
							trainSearchResult),
					"<b>Actual Result:</b> The Popup is displayed and the Boarding Points available are:"
							+ trainSearchResult.gettingBoardingPoints(),
					"<b>Actual Result:</b> The Popup is not displayed", driver);
	...
	public void TC_Yatra_Train_012(HashMap<String, String> testData) throws Exception {
		...
		try {
			...
			Log.message("<br>");
			Log.assertThat(
					trainSearchResult.elementLayer.verifyPageElements(Arrays.asList("tabPrevDay", "tabNextDay"),
							trainSearchResult),
					"<b>Actual Result:</b> Both Previous and Next Tab is displayed on 'Train Search Result' page.",
					"<b>Actual Result:</b> Both Previous and Next Tab is not displayed on 'Train Search Result' page.",
					driver);
	...
	@Test(groups = {
			"desktop" }, description = "Verify Dropping point,Boarding point,depart time,arrival time in fliters.", dataProviderClass = DataProviderUtils.class, dataProvider = "multipleExecutionData")
	public void TC_Yatra_Train_018(HashMap<String, String> testData) throws Exception {
		...
		try {
			...
			Log.message("<br>");
			Log.message(
					"<b>Expected Result:</b> Verify Dropping point,Boarding point,depart time,arrival time in fliters.");

			Log.assertThat(
					trainSearchResult.elementLayer.verifyPageElements(Arrays.asList("lftNavSection"),
							trainSearchResult),
					"<b>Actual Result:</b> The Left Navigation is present and the sections are displayed with the headings.:"
							+ trainSearchResult.getLeftNavHeading(),
	...
	@Test(groups = {
			"desktop" }, description = "Verify for guest user flow.", dataProviderClass = DataProviderUtils.class, dataProvider = "multipleExecutionData")
	public void TC_Yatra_Train_023(HashMap<String, String> testData) throws Exception {
		...
		try {
			...
			Log.assertThat(
					trainReviewPage.elementLayer.verifyPageElements(Arrays.asList("btnModifyItinerary"),
							trainReviewPage),
	...
	@Test(groups = {
			"desktop" }, description = "Verify for Signed User flow.", dataProviderClass = DataProviderUtils.class, dataProvider = "multipleExecutionData")
	...
	@Test(groups = {
			"desktop" }, description = "Check for Mobile Number validation.", dataProviderClass = DataProviderUtils.class, dataProvider = "multipleExecutionData")
	...
	@Test(groups = {
			"desktop" }, description = "Verify user should be able to change ID and save.", dataProviderClass = DataProviderUtils.class, dataProvider = "multipleExecutionData")
	...
	@Test(groups = {
			"desktop" }, description = "Check for coach Id validations and validation for accepting policy.", dataProviderClass = DataProviderUtils.class, dataProvider = "multipleExecutionData")
	public void TC_Yatra_Train_040(HashMap<String, String> testData) throws Exception {
		...
		try {
			...
			Log.assertThat(
					trainTravellerPage.elementLayer.verifyPageElements(Arrays.asList("btnContinue"),
							trainTravellerPage),
					"<b>Actual Result:</b> Unable to navigate to Review Page in case of invalid coach ID and the invalid message is :"
							+ msg,
			...
			Log.assertThat(
					trainTravellerPage.elementLayer.verifyPageElements(Arrays.asList("btnContinue"),
							trainTravellerPage),
					"<b>Actual Result:</b> Unable to navigate to Review Page in case of we don't accept terms & conditions  and the invalid message is :"
							+ msg1,
	...
	@Test(groups = {
			"desktop" }, description = "Check for modify traveller.", dataProviderClass = DataProviderUtils.class, dataProvider = "multipleExecutionData")
	public void TC_Yatra_Train_041(HashMap<String, String> testData) throws Exception {
		...
		try {
			...
			Log.message("<br>");
			Log.message(
					"<b>Expected Result:</b> Verify after clicking on Modify traveller button in Review Page,should redirect back to Pax page.");
			Log.assertThat(
					trainTravellerPage.elementLayer.verifyPageElements(Arrays.asList("btnResetPwd"),
							trainTravellerPage),
	...
	@Test(groups = {
			"desktop" }, description = "Check details of Pax, selected train and travel time & date.", dataProviderClass = DataProviderUtils.class, dataProvider = "multipleExecutionData")
	...
	@Test(groups = {
			"desktop" }, description = "Check for all payment options.", dataProviderClass = DataProviderUtils.class, dataProvider = "multipleExecutionData")
	...
	@Test(groups = {
			"desktop" }, description = "Should show proper message on payment page,after cancelling transaction.", dataProviderClass = DataProviderUtils.class, dataProvider = "multipleExecutionData")
	public void TC_Yatra_Train_049(HashMap<String, String> testData) throws Exception {
		...
		try {
			...
			Log.message("<br>");
			Log.message(
					"<b>Expected Result:</b> Verify after cancelling transaction should show proper message on payment page.");
			Log.assertThat(paymentPage.elementLayer.verifyPageElements(Arrays.asList("msgFailedTransctn"), paymentPage),
					"<b>Actual Result:</b> Proper message is displayed on Paymentpage after the failed transaction.:\n ERROR MESSAGE:"
							+ errorMsg,
					"<b>Actual Result:</b> Proper message is not displayed on Paymentpage after the failed transaction.",
					driver);
