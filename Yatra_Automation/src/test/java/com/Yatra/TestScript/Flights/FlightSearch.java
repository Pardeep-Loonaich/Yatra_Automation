...
public class FlightSearch {
	...
	@Test(groups = {
			"desktop" }, description = "Preferred Airline search Domestic-One Way", dataProviderClass = DataProviderUtils.class, dataProvider = "multipleExecutionData")
	...
	@Test(groups = {
			"desktop" }, description = "Preferred Airline search Domestic-Round Trip", dataProviderClass = DataProviderUtils.class, dataProvider = "multipleExecutionData")
	...
	@Test(groups = {
			"desktop" }, description = "Preferred Airline search International-One Way", dataProviderClass = DataProviderUtils.class, dataProvider = "multipleExecutionData")
	...
	@Test(groups = {
			"desktop" }, description = "Preferred Airline search International-Round Trip", dataProviderClass = DataProviderUtils.class, dataProvider = "multipleExecutionData")
	...
	public void TC_Yatra_Flight_031(HashMap<String, String> testData) throws Exception {
		...
		try {
			...
			Thread.sleep(5000);
			Log.assertThat(reviewPage.elementLayer.verifyPageElements(Arrays.asList("mealDetails"), reviewPage),
	...
	public void TC_Yatra_Flight_032(HashMap<String, String> testData) throws Exception {
		...
		try {
			...
			Thread.sleep(5000);
			Log.assertThat(reviewPage.elementLayer.verifyPageElements(Arrays.asList("btnAddMeal"), reviewPage),
	...
	public void TC_Yatra_Flight_034(HashMap<String, String> testData) throws Exception {
		...
		try {
			...
			Thread.sleep(5000);
			Log.assertThat(reviewPage.elementLayer.verifyPageElements(Arrays.asList("BaggageDetails"), reviewPage),
	...
	public void TC_Yatra_Flight_035(HashMap<String, String> testData) throws Exception {
		...
		try {
			...
			Log.message("<b>Expected Result:</b> User should be able to Remove the Meal Charges On Review Page!");
			Thread.sleep(5000);
			Log.assertThat(reviewPage.elementLayer.verifyPageElements(Arrays.asList("btnAddBaggage"), reviewPage),
	...
	@Test(groups = {
			"desktop" }, description = "Guest flow - Verification of Book As Guest button ", dataProviderClass = DataProviderUtils.class, dataProvider = "parallelTestDataProvider")
	...
	public void TC_Yatra_Flight_044(HashMap<String, String> testData) throws Exception {
		...
		try {
			...
			reviewPage.enterUserDeatils();
			Log.message("7. Enter User Details!");

			PaymentPage paymentPage = reviewPage.clickOnContinueBtnInTravellerPage();
			Log.message("8. Clicked On continue Button!");

			paymentPage.enterCreditCardDetails();
			Log.message("9. Fill Credit Card Details!");

			paymentPage.clickOnPayNow();
			Log.message("10.Click On Pay Now!");
	...
	public void TC_Yatra_Flight_018(HashMap<String, String> testData) throws Exception {
		...
		try {
			...
			Thread.sleep(5000);
			Log.assertThat(
					searchResult.elementLayer.verifyPageElements(Arrays.asList("btnBookNowFlightDeatilPopUp"), searchResult),
					"<b>Actual Result:</b> Book Now Button is Properly Displayed and Details are Displayed as :" + flightDeatils,
	...
	public void TC_Yatra_Flight_019(HashMap<String, String> testData) throws Exception {
		...
		try {
			...
			Log.assertThat(
					searchResult.elementLayer.verifyPageElements(Arrays.asList("btnBookNowFlightDeatilPopUp"), searchResult),
					"<b>Actual Result:</b> After Clicking on Fare And Rule Details, Fare Deatils are properly displayed as:" + Flightfare  ,
					"<b>Actual Result:</b> After Clicking on Fare And Rule Details, Fare Deatils are not properly displayed", driver);
