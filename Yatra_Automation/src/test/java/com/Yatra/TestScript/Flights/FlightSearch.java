...
public class FlightSearch extends BaseTest {
	...
	public void TC_Yatra_Flight_002(HashMap<String, String> testData) throws Exception {
		...
		try {
			...
			// step: Successfully applied filter for specfic airline
			searchResult.selectAirlineInAirlineFilters(airlines);
			Log.message("10.Successfully applied filter for <b>" + airlines + "</b> airline");
	...
	public void TC_Yatra_Flight_005(HashMap<String, String> testData) throws Exception {
		...
		try {
			...
			Log.message(
					"4.Successfully entered Multicity Destination1 '<b>" + destination1 + "</b>' in Yatra Homepage");
			...
			Log.message(
					"7.Successfully entered Multicity Destination1 '<b>" + destination2 + "</b>' in Yatra Homepage");
			...
			// step: Successfully applied filter for specfic airline
			searchResult.selectAirlineInAirlineFilters(airlines);
			Log.message("12.Successfully applied filter for <b>" + airlines + "</b> airline");
			...
			Log.assertThat(
					...
					"<b>Actual Result:</b> User should not navigated on SearchResult page for DOM-Multicity", driver);
	...
	public void TC_Yatra_Flight_006(HashMap<String, String> testData) throws Exception {
		...
		try {
			...
			Log.assertThat(
					...
					"<b>Actual Result:</b> User should not navigated on SearchResult page for INTL-Multicity", driver);
	...
	public void TC_Yatra_Flight_007(HashMap<String, String> testData) throws Exception {
		...
		try {
			...
			Log.message("<br>");
			Log.message(
					"<b>Expected Result:</b> Validating the different modules of Search Result Page for OneWay(OW) search");
			BrowserActions.nap(2);
			Log.assertThat(searchResult.verifySRPMenu(tripType),
					"<b>Actual Result:</b> SRP Page should appeared with <b>Modify Search button, Airline Matrix, Filter options, SRP Results (Tabular form), Share Itinerary and Footer </b>headers",
					"<b>Actual Result:</b> SRP Page should not appeared with <b> Modify Search button, Airline Matrix, Filter options, SRP Results (Tabular form), Set Fare Alerts, Share Itinerary and Footer </b>headers",
					driver);
			Log.testCaseResult();
		} catch (Exception e) {
			Log.exception(e);
	...
	public void TC_Yatra_Flight_008(HashMap<String, String> testData) throws Exception {
		...
		try {
			...
			Log.message("<br>");
			Log.message(
					"<b>Expected Result:</b> Validating the different modules of Search Result Page for Round Trip(RT) search");
			BrowserActions.nap(2);
			Log.assertThat(searchResult.verifySRPMenu(tripType),
					...
					"<b>Actual Result:</b> SRP Page should not appeared with <b> Modify Search button, Airline Matrix, Prev Day/Next Day search, LFF calendar, Filter options, SRP Results (Tabular form), Set Fare Alerts, Share Itinerary and Footer headers </b>",
					driver);
			Log.testCaseResult();
		} catch (Exception e) {
			Log.exception(e);
	...
	public void TC_Yatra_Flight_009(HashMap<String, String> testData) throws Exception {
		...
		try {
			...
			Log.message("<br>");
			Log.message(
					"<b>Expected Result:</b> Validating the different modules of Search Result Page for MultiCity(MC) search ");
			BrowserActions.nap(2);
			Log.assertThat(searchResult.verifySRPMenu(tripType),
					...
					"<b>Actual Result:</b> SRP Page should not appeared with<b> Modify Search button, Airline Matrix, Prev Day/Next Day search, Filter options, SRP Results (Tabular form), Share Itinerary and Footer</b> headers",
					driver);
	...
	public void TC_Yatra_Flight_010(HashMap<String, String> testData) throws Exception {
		...
		try {
			...
			BrowserActions.nap(2);
			Log.assertThat(
					searchResult.elementLayer.verifyPageElements(Arrays.asList("btnModifySearchIcon", "lnkYatraLogo"),
							searchResult),
					"<b>Actual Result:</b> Yatra logo and Headers are displayed, The Headers title names are My Account is displayed as: <b>: "
							+ myAccountText + "</b>, Support is dispalyed as <b>: " + supportText
							+ "</b>, Special Deals is dispalyed as <b>: " + splDealsText
							+ "</b>, Recent Search is dispalyed as : <b>" + recentSearchText + "</b> ",
	...
	public void TC_Yatra_Flight_011(HashMap<String, String> testData) throws Exception {
		...
		try {
			...
			Log.assertThat(homePage.elementLayer.verifyPageElements(Arrays.asList("btnSearch"), homePage),
					...
					"<b>Actual Result:</b> Yatra.com tooltip should not appeared and not redirected to Yatra Homepage",
					driver);
	...
	public void TC_Yatra_Flight_012(HashMap<String, String> testData) throws Exception {
		...
		try {
			...
			Log.assertThat(
					searchResult.elementLayer.verifyPageElements(Arrays.asList("btnModifySearchIcon", "lnkYatraLogo"),
							searchResult),
					"<b>Actual Result:</b> Yatra logo and logged in User menu items are displayed, UserName is <b>: "
							+ userAcctNametText + "</b>, Support is dispalyed as <b>: " + supportText
							+ "</b>, Special Deals is dispalyed as <b>: " + splDealsText
							+ "</b>, Recent Search is dispalyed as : <b>" + recentSearchText + "</b> ",
	...
	public void TC_Yatra_Flight_013(HashMap<String, String> testData) throws Exception {
		...
		try {
			...
			Log.assertThat(
					searchResult.elementLayer.verifyPageElements(Arrays.asList("btnModifySearchIcon", "lnkYatraLogo"),
							searchResult),
					"<b>Actual Result:</b> Successfully displayed My Account header menu items, and the Login is dispalyed as <b>: "
							+ loginText + "</b>, SignUp is dispalyed as <b>: " + signUpText
							+ "</b>, Corporate Login is dispalyed as <b>: " + corporateLoginText
							+ "</b>, Agent Login is dispalyed as : <b>" + agentLoginText
							+ "</b>, My Bookings is dispalyed as : <b>" + myBookingText + "</b> ",
	...
	public void TC_Yatra_Flight_014(HashMap<String, String> testData) throws Exception {
		...
		try {
			...
			Log.assertThat(
					searchResult.elementLayer.verifyPageElements(Arrays.asList("btnModifySearchIcon"), searchResult),
					"<b>Actual Result:</b> Successfully verified Flight count and Search duration, and the total Flight Count: <b> "
							+ flightCount + "</b>, Flight search durarion: <b> " + duration + "</b> ",
	...
	public void TC_Yatra_Flight_015(HashMap<String, String> testData) throws Exception {
		...
		try {
			...
			Log.assertThat(
					searchResult.elementLayer.verifyPageElements(Arrays.asList("btnModifySearchIcon"), searchResult),
					"<b>Actual Result:</b> Successfully validated Matrix result, Source city: <b> " + sourceCityText
							+ "</b>, Source Date: <b> " + sourceDateText + "</b> and Destination city:<b> "
							+ destCityText + "</b> ",
	...
	public void TC_Yatra_Flight_016(HashMap<String, String> testData) throws Exception {
		...
		try {
			...
			Log.assertThat(resultStripText.equals("VIEWED"), "<b>Actual Result:</b> Validated Result Strip",
					"<b>Actual Result:</b> Not Validated Result Strip");

			Log.message("<br>");
			Log.message(
					"<b>Expected Result:</b> Validated that Duration should appear in 'hh mm' format across the SRP ");
			BrowserActions.nap(2);
			Log.assertThat(
					searchResult.elementLayer.verifyPageElements(Arrays.asList("btnModifySearchIcon"), searchResult),
					"<b>Actual Result:</b> User should navigated on SearchResult page, and the Flight duration format is dispalyed as like 'hh mm' <b>: "
							+ flightDurationText
							+ "</b>, Flight details popup duration format is dispalyed as like 'hh mm' <b>: "
							+ flightDetailsPouUpDurationText + "</b>  ",
					"<b>Actual Result:</b> User should not navigated on SearchResult page, and the Flight duration format is not dispalyed as like 'hh mm' <b>: "
							+ flightDurationText
							+ "</b>, Flight details popup duration format is dispalyed as like 'hh mm' <b>: "
							+ flightDetailsPouUpDurationText + "</b>",
					driver);
	...
	public void TC_Yatra_Flight_017(HashMap<String, String> testData) throws Exception {
		...
		try {
			...
			// step: Successfully applied filter for specfic airline
			searchResult.selectAirlineInAirlineFilters(airlines);
			Log.message("9.Successfully applied filter for <b>" + airlines + "</b> airline");
			...
			Log.assertThat(searchResult.verifyTripTypeInModifySearch(tripType),
					"<b>Actual Result:</b> Successfully selected One Way Radio button",
					"<b>Actual Result:</b> Not selected One Way Radio button");
			Log.assertThat(originCityText.contains(destination),
					"<b>Actual Result:</b> Successfully verified Modify Search Origin City, Orgin City:  <b> "
							+ destination + "</b>",
					"<b>Actual Result:</b> Not verified Modify Searcch Origin City");
			Log.assertThat(destCityText.contains(origin),
					"<b>Actual Result:</b> Successfully verified Modify Search Destination City, Destination City:  <b> "
							+ origin + "</b>",
					"<b>Actual Result:</b> Not verified Modify Search Destination City");
			...
			Log.assertThat(adultText.contains(adult),
					"<b>Actual Result:</b> Successfully verified Modify Search Adult passenger details, Selected Adult is:  <b> "
							+ adult + "</b>",
					"<b>Actual Result:</b> Not verified Modify Search Adult passenger details</b> ", driver);

			Log.assertThat(childText.contains(child),
					"<b>Actual Result:</b> Successfully verified Modify Search Child passenger details, Selected Child is:  <b>"
							+ child + "</b>",
					"<b>Actual Result:</b> Not verified Modify Search Child passenger details</b> ", driver);

			Log.assertThat(infantText.contains(infant),
					"<b>Actual Result:</b> Successfully verified Modify Search Infant passenger details, Selected Infant is: <b>+ "
							+ infant + "</b>",
			...
			Log.assertThat(passengerClassText.contains(passengerClass),
					"<b>Actual Result:</b> Successfully verified Modify Search passenger class details, Selected Passenger Class: <b>"
							+ passengerClassText + " </b> ",
	...
	public void TC_Yatra_Flight_018(HashMap<String, String> testData) throws Exception {
		...
		try {
			...
			Log.message("11.Successfully clicked 'Modify Search' link in SRP ");

			String originCityText = searchResult.getTextOrigin_ModifySearch();
			String destCityText = searchResult.getTextDestination_ModifySearch();
			Log.assertThat(searchResult.verifyTripTypeInModifySearch(tripType),
					"<b>Actual Result:</b> Successfully selected Round Trip Radio button",
					"<b>Actual Result:</b> Not selected Round Trip Radio button");
			Log.assertThat(originCityText.contains(destination),
					"<b>Actual Result:</b> Successfully verified Modify Search prefilled Origin City, Orgin City:  <b> "
							+ destination + "</b>",
					"<b>Actual Result:</b> Not verified Modify Search Origin City");
			Log.assertThat(destCityText.contains(origin),
					"<b>Actual Result:</b> Successfully verified Modify Search prefilled Destination City, Destination City:  <b> "
							+ origin + "</b>",
					"<b>Actual Result:</b> Not verified Modify Search Destination City");

			// TODO: To change the logic for depart date verification (like 10,
			// 20, 30 dates in moth level)
			/*
			 * String deprtDateText =
			 * searchResult.getTextDepartDate_ModifySearch(); String[] depart =
			 * deprtDateText.split("/");
			 * Log.assertThat(departDate.equalsIgnoreCase(depart[2]+"_"+depart[1
			 * ].replace("0", "")+"_"+depart[0].replace("0", "")),
			 * "<b>Actual Result:</b> Successfully verified selected Departure date, Departure Date is: <b> "
			 * + deprtDateText+"</b>",
			 * "<b>Actual Result:</b> Not verified selected Departure date</b> "
			 * , driver);
			 * 
			 * //TODO: To change the logic for return date verification (like
			 * 10, 20, 30 dates in moth level) String returnDateText =
			 * searchResult.getTextReturnDate_ModifySearch(); String[]
			 * arrayReturndate = returnDateText.split("/");
			 * Log.assertThat(returndate.equalsIgnoreCase(arrayReturndate[2]+"_"
			 * +arrayReturndate[1].replace("0",
			 * "")+"_"+arrayReturndate[0].replace("0", "")),
			 * "<b>Actual Result:</b> Successfully verified selected Return date, Return Date is: <b> "
			 * + returnDateText+"</b>",
			 * "<b>Actual Result:</b> Not verified selected Return date</b> ",
			 * driver);
			 */
			...
			String infantText = searchResult.getTextInfant_ModifySearch();
			Log.assertThat(adultText.contains(adult),
					"<b>Actual Result:</b> Successfully verified Modify Search prefilled Adult passenger details, Selected Adult is:  <b> "
							+ adult + "</b>",
					"<b>Actual Result:</b> Not verified Modify Search prefilled Adult passenger details</b> ", driver);

			Log.assertThat(childText.contains(child),
					"<b>Actual Result:</b> Successfully verified Modify Search prefilled Child passenger details, Selected Child is:  <b> "
							+ child + "</b>",
					"<b>Actual Result:</b> Not verified Modify Search prefilled Child passenger details</b> ", driver);

			Log.assertThat(infantText.contains(infant),
					"<b>Actual Result:</b> Successfully verified Modify Search prefilled Infant passenger details, Selected Infant is:  <b> "
							+ infant + "</b>",
			...
			Log.assertThat(passengerClass.contains(passengerClassText),
					"<b>Actual Result:</b> Successfully verified Modify Search prefilled passenger class details, Selected Passenger Class: <b>"
							+ passengerClassText + " </b> ",
	...
	public void TC_Yatra_Flight_019(HashMap<String, String> testData) throws Exception {
		...
		try {
			...
			String destCityText = searchResult.getTextDestination_ModifySearch();
			Log.assertThat(searchResult.verifyTripTypeInModifySearch(tripType),
					"<b>Actual Result:</b> Successfully selected Multicity Radio button",
					"<b>Actual Result:</b> Not selected Multicity Radio button");
			Log.assertThat(originCityText.contains(destination1),
					"<b>Actual Result:</b> Successfully verified Modify Search prefilled  Origin1 City ",
					"<b>Actual Result:</b> Not verified Modify Search prefilled  Origin1 City");
			Log.assertThat(destCityText.contains(origin1),
					"<b>Actual Result:</b> Successfully verified Modify Search prefilled Destination1  City ",
					"<b>Actual Result:</b> Not verified Modify Search prefilled Multicity City");
			...
			Log.assertThat(originCityText_MC.contains(destination2),
					"<b>Actual Result:</b> Successfully verified Modify Search prefilled Origin2 City  ",
					"<b>Actual Result:</b> Not verified Modify Search prefilled Origin2 City");
			Log.assertThat(destCityText_MC.contains(origin2),
					"<b>Actual Result:</b> Successfully verified Modify Search prefilled Destination2 City name",
					"<b>Actual Result:</b> Not verified Modify Search prefilled Multicity City");
			...
			Log.assertThat(infantText.contains(infant),
					"<b>Actual Result:</b> Successfully verified selectModify Search prefilleded Infant passenger details, Selected Infant is:  <b> "
							+ infant + "</b>",
					"<b>Actual Result:</b> Not verified Modify Search prefilled Infant passenger details</b> ", driver);
	...
	public void TC_Yatra_Flight_023(HashMap<String, String> testData) throws Exception {
		...
		try {
			...
			Log.assertThat(
					searchResult.elementLayer.verifyPageElements(Arrays.asList("PaxDeatilInModify"), searchResult),
	...
	public void TC_Yatra_Flight_024(HashMap<String, String> testData) throws Exception {
		...
		try {
			...
			Log.message("<br>");
			Log.message(
					"<b>Expected Result:</b> Validated that for DOM search Class dropdown would not contain First Class option");
			BrowserActions.nap(2);
			Log.assertThat(!passengerClassNames.contains("First Class"),
					"<b>Actual Result:</b> DOM Flights Passenger Class dropdown sholud not contain First Class option</b>, Passenger Class List are :<b> "
							+ passengerClassNames + "<b>",
					"<b>Actual Result:</b> DOM Flights Passenger Class dropdown sholud contain First Class option</b> Passenger Class List are : <b> "
							+ passengerClassNames + "<b>",
					driver);
	...
	public void TC_Yatra_Flight_025(HashMap<String, String> testData) throws Exception {
		...
		try {
			...
			Log.message("<br>");
			Log.message(
					"<b>Expected Result:</b> Validated that for INT search Class dropdown contain First Class option");
			BrowserActions.nap(2);
			Log.assertThat(passengerClassNames.contains("First Class"),
					"<b>Actual Result:</b> INT Flights Passenger Class dropdown sholud contain First Class option</b>, Passenger Class List are :<b>  "
							+ passengerClassNames + "<b>",
					"<b>Actual Result:</b> INT Flights Passenger Class dropdown sholud not contain First Class option</b> Passenger Class List are :<b> "
							+ passengerClassNames + "<b>",
					driver);
	...
	public void TC_Yatra_Flight_026(HashMap<String, String> testData) throws Exception {
		...
		try {
			...
			// step: Successfully applied filter for specfic airline
			searchResult.selectAirlineInAirlineFilters(airlines);
			Log.message("5.Successfully applied filter for <b>" + airlines + "</b> airline");
			...
			Log.assertThat(searchResult.verifyCurrentDateSelectionInWeeklyMatrix(),
					"<b>Actual Result:</b> Successfully selected Current date in weekly matrix",
					"<b>Actual Result:</b> Not selected Current date in weekly matrix");
			...
			Log.assertThat(currentdateFareText.equalsIgnoreCase(lowesrFlightFareText),
					"<b>Actual Result:</b> Successfully shown lowest fare in matrix for that date, Fare: <b> "
							+ currentdateFareText + "</b>",
	...
	public void TC_Yatra_Flight_027(HashMap<String, String> testData) throws Exception {
		...
		try {
			...
			Log.message("<br>");
			Log.message(
					"<b>Expected Result:</b> Validated that Weekly fare Matrix will not be available for RT search");
			BrowserActions.nap(50);
			Log.assertThat(
					searchResult.elementLayer.verifyPageElementsDoNotExist(Arrays.asList("weeklyFlightsStrip"),
							searchResult),
					"<b>Actual Result:</b> The Weekly fare Matrix not displayed on the SRP page for RT Search",
					"<b>Actual Result:</b> The Weekly fare Matrix displayed on the SRP page for RT Search", driver);
	...
	public void TC_Yatra_Flight_028(HashMap<String, String> testData) throws Exception {
		...
		try {
			...
			homePage.selectMultiCityFlightSearchFields(origin1, destination1, departureDate1, origin2, destination2,
					departureDate2, passengerInfo, passengerClass);
			...
			Log.message("<br>");
			Log.message(
					"<b>Expected Result:</b> Validating that Weekly fare Matrix will not be available for MC search");
			BrowserActions.nap(10);
			Log.assertThat(
					searchResult.elementLayer.verifyPageElementsDoNotExist(Arrays.asList("weeklyFlightsStrip"),
							searchResult),
					"<b>Actual Result:</b> The Weekly fare Matrix not displayed on the SRP page for MC Search",
					"<b>Actual Result:</b> The Weekly fare Matrix displayed on the SRP page for MC Search", driver);
			Log.testCaseResult();
		} catch (Exception e) {
			Log.exception(e);
		} finally {
	...
	public void TC_Yatra_Flight_029(HashMap<String, String> testData) throws Exception {
		...
		try {
			...
			Log.assertThat(searchResult.verifyAllAirlineMatrixSelection(),
					"<b>Actual Result:</b> 'All Airlines' option should appear with deafult selection ",
					"<b>Actual Result:</b> 'All Airlines' option should not appear with deafult selection", driver);
			...
			Log.assertThat(
					...
					"<b>Actual Result:</b> Airline Matrix flights arranged to increasing orderwise fare: <b>"
							+ airlineMatrixFareDetails + "</b>",
					"<b>Actual Result:</b> Airline Matrix flights increasing fare is not displayed on Search Result page",
					driver);
	...
	public void TC_Yatra_Flight_030(HashMap<String, String> testData) throws Exception {
		...
		try {
			...
			Log.message("<br>");
			Log.message(
					"<b>Expected Result:</b> User should redirected to SRP and Validating the UI of Airline Matrix");
			Log.assertThat(searchResult.verifyAllAirlineMatrixSelection(),
					"<b>Actual Result:</b> 'All Airlines' option should appear with by deafult selection ",
					"<b>Actual Result:</b> 'All Airlines' option should not appear with by deafult selection", driver);
			Log.assertThat(searchResult.verifyAirlinelogoInMatrix(),
					"<b>Actual Result:</b> Successfully displayed Airline Logo's in Airline Matrix strip ",
					"<b>Actual Result:</b> Not displayed Airline Logo's in Airline Matrix strip", driver);
			List<String> airlineNames = searchResult.getAirlineNamesInMatrix();
			List<String> airlineMatrixFareDetails = searchResult.getAirlineMatrixFareDetails();
			Log.assertThat(
					searchResult.elementLayer.verifyPageElements(Arrays.asList("lnkAirlineMatrixStrip"), searchResult),
					"<b>Actual Result:</b> Airline Matrix flights arranged to increasing lowest fare orderwise, Airline Names: <b>"
							+ airlineNames + "</b>, and lowest fare of respective Airlines <b>"
							+ airlineMatrixFareDetails + "</b>",
					"<b>Actual Result:</b> Airline Matrix flights not arranged to increasing lowest fare orderwise",
					driver);
	...
	public void TC_Yatra_Flight_031(HashMap<String, String> testData) throws Exception {
		...
		try {
			...
			Log.assertThat(searchResult.verifySelectedAirlineInAirlineFilters(airlineName),
					"<b>Actual Result:</b> Successfully verified selected Airline in Filter Airline, Selected Airline Name: <b>"
							+ airlineName + "</b> ",
	...
	public void TC_Yatra_Flight_032(HashMap<String, String> testData) throws Exception {
		...
		try {
			...
			Log.message("<br>");
			Log.message(
					"<b>Expected Result:</b> Prev day/Next day search option should not be available on SRP for OW search");
			Log.assertThat(
					!(searchResult.verifyOnwardAndReturnLFF("PrevDay")
							&& searchResult.verifyOnwardAndReturnLFF("NextDay")),
					"<b>Actual Result:</b> Successfully validated Prev day/Next day search option are not available on SRP",
					"<b>Actual Result:</b> Prev day/Next day search option are available on SRP", driver);
			Log.testCaseResult();
		} catch (Exception e) {
			Log.exception(e);
		} finally {
	...
	public void TC_Yatra_Flight_033(HashMap<String, String> testData) throws Exception {
		...
		try {
			...
			Log.message("<br>");
			Log.message(
					"<b>Expected Result:</b> Prev day/Next day search option should be available above Result Grid for both Onward and Return leg in SRP");
			Log.assertThat(
					(searchResult.verifyOnwardLegLinks("PrevDay") && searchResult.verifyOnwardLegLinks("NextDay")),
					"<b>Actual Result:</b> Successfully validated Prev day/Next day search options on Onward leg in SRP",
					"<b>Actual Result:</b> Prev day/Next day search options are not available on Onwards leg in SRP",
					driver);
			Log.assertThat(
					(searchResult.verifyReturnLegLinks("PrevDay") && searchResult.verifyReturnLegLinks("NextDay")),
					"<b>Actual Result:</b> Successfully validated Prev day/Next day searchs on Return leg in SRP",
					"<b>Actual Result:</b> Prev day/Next day search options are not available on Return leg in SRP",
					driver);
			Log.testCaseResult();
		} catch (Exception e) {
			Log.exception(e);
	...
	public void TC_Yatra_Flight_034(HashMap<String, String> testData) throws Exception {
		...
		try {
			...
			Log.assertThat(!(dapartureDateBefore.equals(dapartureDateAfter)),
					"<b>Actual Result:</b> Successfully updated Result set following changes",
					"<b>Actual Result:</b> Result set is not updated following changes", driver);
			Log.testCaseResult();
		} catch (Exception e) {
			Log.exception(e);
		} finally {
		...
		try {
			...
			Log.assertThat(
					searchResult.elementLayer.verifyPageElements(
							Arrays.asList("lnkPrevDay_OnwardLeg", "lnkNextDay_OnwardLeg"), searchResult),
					"<b>Actual Result:</b> Successfully appeared tool tip of Prev/Next dates on Onwards Leg: <b>"
							+ onwardPrevDayText + "</b> / <b>" + onwardNextDayText + "</b> and Return leg: <b>"
							+ nextPrevDayText + "</b> / <b>" + nextNextDayText + "</b>",
					"<b>Actual Result:</b> Not Prev day/Next day search button tool tips text should appear in SRP",
					driver);
			Log.testCaseResult();
		} catch (Exception e) {
			Log.exception(e);
	...
	public void TC_Yatra_Flight_037(HashMap<String, String> testData) throws Exception {
		...
		try {
			...
			Log.assertThat(!searchResult.verifyOnwardAndReturnLFF("OLFF"),
					"<b>Actual Result:</b> Successfully validated LFF is not displayed for MC Search",
					"<b>Actual Result:</b> LFF is displayed for MC Search", driver);
			Log.testCaseResult();
		} catch (Exception e) {
			Log.exception(e);
		} finally {
	...
	public void TC_Yatra_Flight_038(HashMap<String, String> testData) throws Exception {
		...
		try {
			...
			Log.assertThat(!searchResult.verifyOnwardAndReturnLFF("OLFF"),
					"<b>Actual Result:</b> Successfully validated LFF is not displayed for OW Search",
					"<b>Actual Result:</b> LFF is displayed for OW Search", driver);
			Log.testCaseResult();
		} catch (Exception e) {
			Log.exception(e);
		} finally {
	...
	public void TC_Yatra_Flight_039(HashMap<String, String> testData) throws Exception {
		...
		try {
			...
			Log.message("<b>Expected Result:</b> Validated that LFF is not available for MC Search");
			Log.assertThat(searchResult.verifyOnwardAndReturnLFF("OLFF"),
					"<b>Actual Result:</b> Successfully validated onward LFF is displayed for RT Search",
					"<b>Actual Result:</b> Onward LFF is not displayed for RT Search", driver);
			Log.assertThat(searchResult.verifyOnwardAndReturnLFF("RLFF"),
					"<b>Actual Result:</b> Successfully validated Return LFF is displayed for RT Search",
					"<b>Actual Result:</b> Return LFF is not displayed for RT Search", driver);

			searchResult.clickOnwardAndReturnLFF("OLFF");
			// String textTravelDetails =
			// searchResult.getTextOnwardAndReturnLFF("OLFF");
			...
			Log.assertThat(
					searchResult.elementLayer.verifyPageElements(Arrays.asList("lnkOnwardLFF", "lnkReturnLFF"),
							searchResult),
					"<b>Actual Result:</b> Successfully verified Onward Calender Name text: <b>" + textOnwardCalender
							+ "</b> and Return Calender Name text: <b>" + textReturnCalender + "</b> ",
	...
	public void TC_Yatra_Flight_040(HashMap<String, String> testData) throws Exception {
		...
		try {
			...
			Log.assertThat(fareAlertTitleText.contains("Set A Fare Alert"),
					"<b>Actual Result:</b> Successfully verified Fare Alert popup title text:  <b>" + fareAlertTitleText
							+ "</b>",
	...
	public void TC_Yatra_Flight_041(HashMap<String, String> testData) throws Exception {
		...
		try {
			...
			String fareAlertTitleText = searchResult.getTextFareAlertPopupTitle();
			Log.assertThat(fareAlertTitleText.contains(Constants.C_FareAlert_Title),
					"<b>Actual Result:</b> Successfully verified Fare Alert popup title text:  <b>" + fareAlertTitleText
							+ "</b>",
					"<b>Actual Result:</b> Not verified Fare Alert popup title text</b> ", driver);
			...
			Log.assertThat(
					searchResult.elementLayer.verifyPageElements(
							Arrays.asList("txtOrigin_FareAlert", "txtDestination_FareAlert"), searchResult),
					"<b>Actual Result:</b> Successfully appeared Leaving from and Going to prefilled text boxes with Depart and Destination city's are <b>"
							+ leavingfromText + "</b> , <b>" + goingToText
							+ "</b> and Successfully appeared Exact Dates / +-3 Days option are : <b>" + ExactDatesText
							+ "</b> , <b>" + daysText + "</b>",
					"<b>Actual Result:</b> Not appeared Leaving from and Going to prefilled text boxes with Depart and Destination city's and  Exact Dates / +-3 Days option in Fare Alerts popup",
					driver);
			...
			Log.assertThat(
					searchResult.elementLayer.verifyPageElements(Arrays.asList("txtMaxPrice_FareAlert",
							"txtEmail_FareAlert", "txtMobile_FareAlert", "btnSetAlert_FareAlert"), searchResult),
					"<b>Actual Result:</b> Successfully appeared Max Price, Email, Mobile, Set Alert button options in Fare Alert popup</b>",
					"<b>Actual Result:</b> Not Max Price, Email, Mobile, Set Alert button options in Fare Alert popup",
					driver);
			...
			Log.assertThat(successMessageText.contains(Constants.C_FareAlert_Message),
					"<b>Actual Result:</b> Successfully verified Fare Alert Message text:  <b>" + successMessageText
							+ "</b>",
					"<b>Actual Result:</b> Not verified Fare Alert popup Message text</b> ", driver);
	...
	public void TC_Yatra_Flight_042(HashMap<String, String> testData) throws Exception {
		...
		try {
			...
			Log.assertThat(shareItineraryText.contains("Share Itinerary"),
					"<b>Actual Result:</b> Successfully should appeared Share Itinerary tool tip ",
					"<b>Actual Result:</b> Not appeared Share Itinerary tool tip ");
			...
			Log.assertThat(shareItineraryMessageText.contains(Constants.C_ShareItinerary_Message),
					"<b>Actual Result:</b> Successfully verified Share Itinerary functionality, Share Itinerary Message text:  <b>"
							+ shareItineraryMessageText + "</b>",
					"<b>Actual Result:</b> Not verified verified Share Itinerary functionality</b> ", driver);
	...
	public void TC_Yatra_Flight_043(HashMap<String, String> testData) throws Exception {
		...
		try {
			...
			Log.assertThat(priceFilterText.toUpperCase().contains(Constants.C_Price),
					"<b>Actual Result:</b> Successfully verified Price filter option in SRP, Price Filter Title :  <b>"
							+ priceFilterText + "</b>",
					"<b>Actual Result:</b> Not verified Price filter option in SRP</b> ", driver);

			String deparTimeFilterText = searchResult.getTextDepartTimeFilterTitle();
			Log.assertThat(deparTimeFilterText.toUpperCase().contains(Constants.C_DepartTime),
					"<b>Actual Result:</b> Successfully verified Depart Time filter option in SRP, Deaprt Time Filter Title :  <b>"
							+ deparTimeFilterText + "</b>",
					"<b>Actual Result:</b> Not verified Depart Time filter option in SRP</b> ", driver);

			String stopFilterText = searchResult.getTextStopsFilterTitle();
			Log.assertThat(stopFilterText.toUpperCase().contains(Constants.C_Stops),
					"<b>Actual Result:</b> Successfully verified Stops option in SRP, Stops Filter Title :  <b>"
							+ stopFilterText + "</b>",
					"<b>Actual Result:</b> Not verified Stops filter option in SRP</b> ", driver);

			String fareTypeFilterText = searchResult.getTextFareTypeFilterTitle();
			Log.assertThat(fareTypeFilterText.toUpperCase().contains(Constants.C_FareType),
					"<b>Actual Result:</b> Successfully verified Fare Type filter option in SRP, Fare Type Filter Title :  <b>"
							+ fareTypeFilterText + "</b>",
					"<b>Actual Result:</b> Not verified Fare Type filter option in SRP</b> ", driver);

			String airlinesFilterText = searchResult.getTextAirlinesFilterTitle();
			Log.assertThat(airlinesFilterText.toUpperCase().contains(Constants.C_Airlines),
					"<b>Actual Result:</b> Successfully verified Airlines filter option in SRP, Airlines Filter Title :  <b>"
							+ airlinesFilterText + "</b>",
					"<b>Actual Result:</b> Not verified Airlines filter option in SRP</b> ", driver);
	...
	public void TC_Yatra_Flight_044(HashMap<String, String> testData) throws Exception {
		...
		try {
			...
			Log.message("<br>");
			Log.message(
					"<b>Expected Result:</b> Validated the Filter if user has selected Non stop Flights only from homepage");
			Log.assertThat(searchResult.verifyNonStopFlightsSelectionInFilters(),
					"<b>Actual Result:</b> Successfully verified Non Stop Flights filter selection in SRP",
					"<b>Actual Result:</b> Not verified Non Stop Flights filter selection in SRP", driver);
			Log.testCaseResult();
		} catch (Exception e) {
			Log.exception(e);
		} finally {
	...
	public void TC_Yatra_Flight_045(HashMap<String, String> testData) throws Exception {
		...
		try {
			...
			Log.assertThat(searchResult.verifyRefundableFlight(),
					"<b>Actual Result:</b> Successfully Flight results have updated with Refundable option in SRP",
					"<b>Actual Result:</b> Not filtered Refundbale Flights in SRP", driver);
	...
	public void TC_Yatra_Flight_046(HashMap<String, String> testData) throws Exception {
		...
		try {
			...
			Log.assertThat(!searchResult.verifyFlightNameTitlesInResultGrid(airlines),
					"<b>Actual Result:</b> Successfully displayed complete result set after clicked Reset All ",
					"<b>Actual Result:</b> Not displayed complete result set after clicked Reset All", driver);
	...
	public void TC_Yatra_Flight_051(HashMap<String, String> testData) throws Exception {
		...
		try {
			...
			Log.assertThat(
					(searchResult.verifySelectedFlightInCurrentSelectionBox("Onward")
							&& searchResult.verifySelectedFlightInCurrentSelectionBox("Return")),
					"<b>Actual Result:</b> Selected flights should be marked on flight listing, Selectd Flights fares : <b>"
							+ flightFare + "</b>",
	...
	public void TC_Yatra_Flight_052(HashMap<String, String> testData) throws Exception {
		...
		try {
			...
			Log.assertThat(searchResult.verifyResultGridColumns(),
					"<b>Actual Result:</b> Successfully Validated Result Grid Column Headers, Column names are: <b>"
							+ resultGridColumns + "</b>",
					"<b>Actual Result:</b> Not validated Result Grid Column Headers", driver);
	...
	public void TC_Yatra_Flight_053(HashMap<String, String> testData) throws Exception {
		...
		try {
			...
			Log.assertThat(searchResult.verifyPriceSorting("Upwards"),
					"<b>Actual Result:</b> Successfully displayed the Price sort arrow by default with Upwards",
					"<b>Actual Result:</b> Not displayed the Price sort arrow by default with Upwards", driver);
	...
	public void TC_Yatra_Flight_054(HashMap<String, String> testData) throws Exception {
		...
		try {
			...
			Log.message("<br>");
			Log.message(
					"<b>Expected Result:</b> Validate that Result Grid can be sorted on the basis of column headers present");
			Log.assertThat(searchResult.verifyPriceSorting("Downwards"),
					"<b>Actual Result:</b> Result grid should sorted on the basis of selection made with Price Sort Arrow and should appeared highlighted heading downwards",
					"<b>Actual Result:</b> Result grid should not sorted on the basis of selection made with Price Sort Arrow and should not appeared highlighted heading downwards",
					driver);
	...
	public void TC_Yatra_Flight_055(HashMap<String, String> testData) throws Exception {
		...
		try {
			...
			Log.assertThat(
					(searchResult.verifyResultGridColumHeaders("Upper")
							&& searchResult.verifyResultGridColumHeaders("Lower")),
					"<b>Actual Result:</b> Result strip should appeared divided two parts in Upper and Lower column Headers",
					"<b>Actual Result:</b> Result strip should appeared divided two parts in Upper and Lower column Headers",
					driver);
	...
	public void TC_Yatra_Flight_065(HashMap<String, String> testData) throws Exception {
		...
		try {
			...
			Log.assertThat(NoOfResultsAfterChangeFlight != NoOfResults,
					...
					"<b>Actual Result :</b> After Clicking On Change Flight Button On Review Page All Filter are not reset to default value",
					driver);
			Log.testCaseResult();
		} catch (Exception e) {
			Log.exception(e);
	...
	public void TC_Yatra_Flight_066(HashMap<String, String> testData) throws Exception {
		...
		try {
			...
			Thread.sleep(2000);
			Log.assertThat(
					Date.equals(DateAfterFlightChange) && originName.equals(originNameAfterFlightChange)
							&& DestinationName.equals(DestinationNameAfterFlightChange),
	...
	public void TC_Yatra_Flight_067(HashMap<String, String> testData) throws Exception {
		...
		try {
			...
			Log.assertThat(resultBeforeChangeFlight != (resultAfterChangeFlight),
					...
					"<b>Actual Result :</b> After clicking on change flight on Review page, only last selected flight is visible",
					driver);
	...
	public void TC_Yatra_Flight_084(HashMap<String, String> testData) throws Exception {
		...
		try {
			...
			Thread.sleep(2000);
			Log.assertThat(
					searchResult.elementLayer.verifyPageElements(Arrays.asList("txtSeatLeftMessageInFlightDetails"),
							searchResult),
	...
	public void TC_Yatra_Flight_104(HashMap<String, String> testData) throws Exception {
		...
		try {
			...
			travellerPage.fillTravellerDetails_DOM(infantDOB);
			Log.message("9. Enter User Details!");
			...
			Log.message("11. Fill Credit Card Details!");

			paymentPage.clickOnPayNow_PaymentPage();
			Log.message("12.Click On Pay Now!");
	...
	public void TC_Yatra_Flight_105(HashMap<String, String> testData) throws Exception {
		...
		try {
			...
			Log.message("11. Fill invalid Debit Card Details!");
	...
	public void TC_Yatra_Flight_116(HashMap<String, String> testData) throws Exception {
		...
		try {
			...
			Log.assertThat(
					searchResult.elementLayer.verifyPageElements(Arrays.asList("btnModifySearchIcon"), searchResult),
					"<b>Actual Result:</b> Successfully validated Matrix result, and the Source city is dispalyed as <b>: "
							+ sourceCityText + "</b>, Source Date is dispalyed as <b>: " + sourceDateText
							+ "</b>, Destination city is dispalyed as <b>: " + destCityText
							+ "</b>, Destination date is dispalyed as <b>: " + destDateText + "</b>",
					"<b>Actual Result:</b> Not displayed Matrix results header with flight icons", driver);
	...
	public void TC_Yatra_Flight_117(HashMap<String, String> testData) throws Exception {
		...
		try {
			...
			Log.assertThat(
					searchResult.elementLayer.verifyPageElements(Arrays.asList("btnModifySearchIcon"), searchResult),
					"<b>Actual Result:</b> Successfully validated Matrix result, and the starting Source city: <b>: "
							+ startSourceCityText + "</b>, Source Date:  <b> " + startSourceDateText
							+ "</b>, Destination city: <b> " + startDestCityText + "</b>, and Ending Source city: <b> "
							+ endSourceCityText + "</b>, Source date:<b> " + endSourceDateText
							+ "</b>, Destination city: <b> " + endDestCityText + "</b>",
					"<b>Actual Result:</b> Not displayed Matrix results header with flight icons", driver);
			Log.testCaseResult();
		} catch (Exception e) {
			Log.exception(e);
	...
	public void TC_Yatra_Flight_120(HashMap<String, String> testData) throws Exception {
		...
		try {
			...
			Log.assertThat(searchResult.verifyTripTypeInModifySearch(tripType),
					...
					"<b>Actual Result:</b> Not selected One Way Radio button");
			Log.assertThat(originCityText.contains(destination),
					"<b>Actual Result:</b> Successfully verified Origin City ",
					"<b>Actual Result:</b> Not verified Origin City");
			Log.assertThat(destCityText.contains(origin),
					"<b>Actual Result:</b> Successfully verified Destination City P",
					"<b>Actual Result:</b> Not verified Destination City ");
	...
	public void TC_Yatra_Flight_121(HashMap<String, String> testData) throws Exception {
		...
		try {
			...
			Log.assertThat(searchResult.verifyTripTypeInModifySearch(tripType),
					...
					"<b>Actual Result:</b> Not selected Round Trip Radio button");
			Log.assertThat(originCityText.contains(destination),
					"<b>Actual Result:</b> Successfully verified Origin City, Origin: <b> " + destination + "</b>",
					"<b>Actual Result:</b> Not verified Origin City ");
			Log.assertThat(destCityText.contains(origin),
					"<b>Actual Result:</b> Successfully verified Destination City, Destination: <b> " + origin + "</b>",
					"<b>Actual Result:</b> Not verified Destination City ");
			...
			String infantText = searchResult.getTextInfant_ModifySearch();
			Log.assertThat(adultText.contains(adult),
					"<b>Actual Result:</b> Successfully verified selected Adult passenger details , Selected Adult is:  <b> "
							+ adult + "</b>",
					"<b>Actual Result:</b> Not verified selected Adult passenger details ", driver);

			Log.assertThat(childText.contains(child),
					"<b>Actual Result:</b> Successfully verified selected Child passenger details, Selected Child is:  <b> "
							+ child + "</b>",
					"<b>Actual Result:</b> Not verified selected Child passenger details  ", driver);

			Log.assertThat(infantText.contains(infant),
					"<b>Actual Result:</b> Successfully verified selected Infant passenger details , Selected Infant is:  <b> "
							+ infant + "</b>",
					"<b>Actual Result:</b> Not verified selected Infant passenger details", driver);

			String passengerClassText = searchResult.getTextPassengerClass_ModifySearch();
			Log.assertThat(passengerClass.contains(passengerClassText),
					"<b>Actual Result:</b> Successfully verified selected passenger class details, Selected Passenger Class: <b>"
							+ passengerClassText + " </b> ",
	...
	public void TC_Yatra_Flight_129(HashMap<String, String> testData) throws Exception {
		...
		try {
			...
			Log.assertThat(
					reviewPage.elementLayer.verifyPageElements(Arrays.asList("PromoCodeErrorMessage"), reviewPage),
					"<b>Actual Result:</b> If invalid Promo Code is Applied an error message is dispalyed as :" + Error,
					"<b>Actual Result:</b> If invalid Promo Code is Applied no error message is dispalyed", driver);
	...
	public void TC_Yatra_Flight_131(HashMap<String, String> testData) throws Exception {
		...
		try {
			...
			Log.message("<br>");
			Log.message(
					"<b>Expected Result:</b> Verify Booking as a Existing User Fill Traveller form move to Payment page");
			BrowserActions.nap(2);
			Log.assertThat(paymentPage.elementLayer.verifyPageElements(Arrays.asList("btnPayNow"), paymentPage),
					"<b>Actual Result:</b> Successfully navigated on paymentPage.",
					"<b>Actual Result:</b> Unable to navigated on paymentPage.", driver);
	...
	public void TC_Yatra_Flight_153(HashMap<String, String> testData) throws Exception {
		...
		try {
			...
			Log.assertThat(
					(searchResult.verifyReturnLegLinks("PrevDay") && searchResult.verifyReturnLegLinks("NextDay")),
					"<b>Actual Result:</b> Successfully validated Prev day/Next day search options on Return leg in SRP",
					"<b>Actual Result:</b> Prev day/Next day search options are not available on Return leg in SRP",
					driver);
			Log.testCaseResult();
		} catch (Exception e) {
