...
public class TravellerPage extends LoadableComponent<TravellerPage> {
	...
	public void fillTravellerDetailsFormDom() throws Exception{
		...
		for(int i=0;i<modTravellerDetails.size();i++  )
		{
			...
			{
				WebElement DOB = driver.findElement(By.xpath("//*[@id='paxNum" +i+ "']/div[@class='col-md-2 col-xs-offset-3 col-md-offset-0 md-align']/span/input[@name='dob" +i+"']"));
				...
				//BrowserActions.typeOnTextField(DOB, dateDOB, driver, "date selected");
